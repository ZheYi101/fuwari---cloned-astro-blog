...
- 数学类科(如高数)70
- 大学英语70
- 编程类(如py,C)70 (你都转计算机了这个要还不到还是早点滚蛋吧)
...
具体往届数据可以上 [http://acm.zjut.edu.cn/onlinejudge/]的contest里找往届转专业考 榜单是允许看的
...
后续就没做出题了 要是C++还行的话 正常就是考虑细节问题 总体机考题难度相当于`洛谷 入门~普通-` 但是细节会故意卡你
## 面试
我这次规则:
